      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24 text-center text-white">
          <div className="inline-flex items-center gap-2 bg-yellow-400/20 border border-yellow-400/30 rounded-full px-4 py-1.5 text-yellow-300 text-sm font-medium mb-6">
            <Star size={14} fill="currentColor" /> Sri Lanka&apos;s #1 Online
            Marketplace
          </div>
          ...
          <p className="text-blue-200 text-lg mb-10 max-w-xl mx-auto">
            Post ads for free and connect with thousands of buyers and sellers
            island-wide.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
            {categories.map((cat) => (
              ...
              >
                <div
                  className={`w-12 h-12 ${cat.color} rounded-xl flex items-center justify-center text-2xl mx-auto mb-2 group-hover:scale-110 transition-transform`}
                >
                  {cat.icon}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="sm:col-span-2 bg-gradient-to-r from-[#1a237e] to-[#3949ab] rounded-2xl p-6 text-white flex items-center justify-between overflow-hidden relative">
              ...
              <div className="relative">
                <span className="bg-yellow-400 text-[#1a237e] text-xs font-bold px-2 py-1 rounded-md mb-3 inline-block">
                  LIMITED OFFER
                </span>
                <h3 className="text-2xl font-bold mb-1">Boost Your Ads</h3>
                <p className="text-blue-200 text-sm mb-4">
                  Get 3x more visibility with our Premium listings
                </p>
                <Link
                  href="/pricing"
                  className="bg-yellow-400 hover:bg-yellow-500 text-[#1a237e] font-bold px-5 py-2 rounded-lg text-sm transition-colors inline-flex items-center gap-1"
                >
            ...
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 text-white relative overflow-hidden">
              ...
              <Link
                href="/ad"
                className="bg-white/20 hover:bg-white/30 font-semibold px-4 py-2 rounded-lg text-sm transition-colors inline-flex items-center gap-1"
              >
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-500 text-center text-sm mb-8">
            The trusted platform for Sri Lankan buyers and sellers
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Use AdMaster on any device. Download our app for the best experience.",
              },
              {
                icon: "🤝",
          ...
          <div className="bg-gradient-to-r from-[#1a237e] to-[#3949ab] rounded-2xl p-8 text-white text-center overflow-hidden relative">
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl font-extrabold mb-2">
                Get the AdMaster App
              </h2>
              <p className="text-blue-200 text-base mb-6 max-w-md mx-auto">
                Buy and sell on the go. Get instant notifications for new ads
                and messages.
              </p>
